...
public class GardiennageAdapter extends
        RecyclerView.Adapter<GardiennageAdapter.ViewHolder> {
    ...
    public GardiennageAdapter(ArrayList<info_gardiennage> infogardiennages) {
        mInfogardiennages = infogardiennages;
    }

    // Usually involves inflating a layout from XML and returning the holder
    @Override
    public GardiennageAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(GardiennageAdapter.ViewHolder holder, int position) {
