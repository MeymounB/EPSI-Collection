...
public class GardiennageAdapter2 extends
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onClick(View view) {
            ...
            if (position != RecyclerView.NO_POSITION) { // Check if an item was deleted, but the user clicked it before the UI removed it
                ...
                final Intent intent;
                intent = new Intent(context, ClientChoixArticleGardiennagePlanifie.class);
    ...
    public GardiennageAdapter2(ArrayList<info_gardiennage> infogardiennages) {
        mInfogardiennages = infogardiennages;
    }

    // Usually involves inflating a layout from XML and returning the holder
    @Override
    public GardiennageAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(GardiennageAdapter2.ViewHolder holder, int position) {
